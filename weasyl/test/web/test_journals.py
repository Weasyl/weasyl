...
def _journals(journal_user):
    db_utils.create_journal(journal_user, title=u'Test journal', content=u'A test journal')
    db_utils.create_journal(journal_user, title=u'Public journal', content=u'A public journal')
    db_utils.create_journal(journal_user, title=u'Hidden journal', content=u'A hidden journal', settings=CharSettings({'hidden'}, {}, {}))
    db_utils.create_journal(journal_user, title=u'Restricted journal', rating=ratings.MATURE.code, content=u'A journal with a non-General rating')
    db_utils.create_journal(journal_user, title=u'Recent journal', content=u'The most recent journal', settings=CharSettings({'friends-only'}, {}, {}))
