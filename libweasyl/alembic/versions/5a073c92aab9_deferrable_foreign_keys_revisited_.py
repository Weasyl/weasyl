...
def upgrade():
    ...
    op.create_foreign_key(None, 'login', 'login', ['voucher'], ['userid'], deferrable=True)
    ...
    op.create_foreign_key(None, 'searchmapchar', 'login', ['added_by'], ['userid'], ondelete='SET NULL', deferrable=True)
    ...
    op.create_foreign_key(None, 'searchmapjournal', 'login', ['added_by'], ['userid'], ondelete='SET NULL', deferrable=True)
    ...
    op.create_foreign_key(None, 'searchmapsubmit', 'login', ['added_by'], ['userid'], ondelete='SET NULL', deferrable=True)
    ...
    op.create_foreign_key(None, 'tag_suggestion_feedback_character', 'login', ['userid'], ['userid'], ondelete='CASCADE', deferrable=True)
    op.create_foreign_key(None, 'tag_suggestion_feedback_character', 'searchtag', ['tagid'], ['tagid'], deferrable=True)
    op.create_foreign_key(None, 'tag_suggestion_feedback_character', 'character', ['targetid'], ['charid'], ondelete='CASCADE', deferrable=True)
    ...
    op.create_foreign_key(None, 'tag_suggestion_feedback_journal', 'searchtag', ['tagid'], ['tagid'], deferrable=True)
    op.create_foreign_key(None, 'tag_suggestion_feedback_journal', 'login', ['userid'], ['userid'], ondelete='CASCADE', deferrable=True)
    op.create_foreign_key(None, 'tag_suggestion_feedback_journal', 'journal', ['targetid'], ['journalid'], ondelete='CASCADE', deferrable=True)
    ...
    op.create_foreign_key(None, 'tag_suggestion_feedback_submission', 'login', ['userid'], ['userid'], ondelete='CASCADE', deferrable=True)
    op.create_foreign_key(None, 'tag_suggestion_feedback_submission', 'submission', ['targetid'], ['submitid'], ondelete='CASCADE', deferrable=True)
    op.create_foreign_key(None, 'tag_suggestion_feedback_submission', 'searchtag', ['tagid'], ['tagid'], deferrable=True)
    ...
    op.create_foreign_key(None, 'user_events', 'login', ['userid'], ['userid'], deferrable=True)
    ...
    op.create_foreign_key(None, 'username_history', 'login', ['replaced_by'], ['userid'], deferrable=True)
    op.create_foreign_key(None, 'username_history', 'login', ['deactivated_by'], ['userid'], deferrable=True)
    op.create_foreign_key(None, 'username_history', 'login', ['userid'], ['userid'], deferrable=True)
...
def downgrade():
    ...
    op.drop_constraint(None, 'username_history', type_='foreignkey')
    op.drop_constraint(None, 'username_history', type_='foreignkey')
    op.drop_constraint(None, 'username_history', type_='foreignkey')
    ...
    op.drop_constraint(None, 'tag_suggestion_feedback_submission', type_='foreignkey')
    op.drop_constraint(None, 'tag_suggestion_feedback_submission', type_='foreignkey')
    op.drop_constraint(None, 'tag_suggestion_feedback_submission', type_='foreignkey')
    ...
    op.drop_constraint(None, 'tag_suggestion_feedback_journal', type_='foreignkey')
    op.drop_constraint(None, 'tag_suggestion_feedback_journal', type_='foreignkey')
    op.drop_constraint(None, 'tag_suggestion_feedback_journal', type_='foreignkey')
    ...
    op.drop_constraint(None, 'tag_suggestion_feedback_character', type_='foreignkey')
    op.drop_constraint(None, 'tag_suggestion_feedback_character', type_='foreignkey')
    op.drop_constraint(None, 'tag_suggestion_feedback_character', type_='foreignkey')
