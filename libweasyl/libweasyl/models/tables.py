...
submission = Table(
    ...
    Column('tag_locked', Boolean(), nullable=False, server_default='f'),
    Column('comment_locked', Boolean(), nullable=False, server_default='f'),
    Column('admin_locked', Boolean(), nullable=False, server_default='f'),
