...
def upgrade():
    ...
    op.create_index('ind_comments_target_sub_commentid', 'comments', ['target_sub', 'commentid'], unique=False, postgresql_where=sa.text('target_sub IS NOT NULL'))
    op.create_index('ind_comments_target_user_commentid', 'comments', ['target_user', 'commentid'], unique=False, postgresql_where=sa.text('target_user IS NOT NULL'))
