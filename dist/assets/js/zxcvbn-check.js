...
const init = () => {
    ...
    forEach(passwordStrengthIndicators, passwordStrength => {
        ...
        const personalFields = (passwordStrength.getAttribute("data-personal-inputs") || "")
            .split(",")
            .filter(Boolean)
            .map(document.getElementById, document);
        const personalData = (passwordStrength.getAttribute("data-personal-data") || "")
            .match(/[a-zA-Z0-9]+/g) || [];
        const check = () => {
            ...
            const personalStrings = personalFields
