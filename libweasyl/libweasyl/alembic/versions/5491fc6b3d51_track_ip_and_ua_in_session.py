...
Create Date: 2018-03-12 21:38:00.789549
...
def upgrade():
    ...
    sa.UniqueConstraint('user_agent_sha256')
    )
    op.create_index('ind_user_agents_user_agent_sha256', 'user_agents', ['user_agent_sha256'], unique=False)
...
def downgrade():
    ...
    op.drop_index('ind_user_agents_user_agent_sha256', table_name='user_agents')
