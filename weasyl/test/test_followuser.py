...
class FollowUserTestCase(unittest.TestCase):
    ...
    def test_insert(self, followuser_insert, followuser_remove, get_config):
        ...
        self.assertFalse(select_relation(user1, user2)["follow"])
        # user1 watches user2
        ...
        # follower of u2
        self.assertTrue(select_relation(user1, user2)["follow"])
        self.assertTrue(select_relation(user2, user1)["follower"])
        self.assertFalse(select_relation(user1, user2)["follower"])
    ...
    def test_insert_ignores(self):
        ...
        self.assertFalse(select_relation(user1, user2)["follow"])
        self.assertFalse(select_relation(user2, user1)["follower"])
    ...
    def test_mutual_follow(self):
        ...
        self.assertTrue(select_relation(user1, user2)["follow"])
        self.assertTrue(select_relation(user2, user1)["follower"])
        self.assertTrue(select_relation(user2, user1)["follow"])
        self.assertTrue(select_relation(user1, user2)["follower"])