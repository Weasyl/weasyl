...
export function asHTMLInputElement(el: unknown): HTMLInputElement {
  if (el instanceof HTMLInputElement) return el;
  throw new Error('Element is not an HTMLInputElement');
}

export function asHTMLDivElement(el: unknown): HTMLDivElement {
  if (el instanceof HTMLDivElement) return el;
  throw new Error('Element is not an HTMLDivElement');
}

export function asHTMLElement(el: unknown): HTMLElement {
  if (el instanceof HTMLElement) return el;
  throw new Error('Element is not an HTMLElement');
}

export function asHTMLAnchorElement(el: unknown): HTMLAnchorElement {
